...
| `index.html` | **Build mobile** — versión a pantalla completa, responsive, instalable como PWA. **Esta es la que sirve GitHub Pages por defecto** |
...
4. Espera 1-2 min. Tu app estará en `https://<tu-usuario>.github.io/<tu-repo>/`

> **Importante**: si quieres mantener `index.html` como la app y `GlutenZero.html` como la demo de diseño, ambas pueden convivir en el mismo repo.

## Convertir a APK con PWABuilder

1. Ve a [pwabuilder.com](https://www.pwabuilder.com)
2. Pega la URL de tu GitHub Pages: `https://<tu-usuario>.github.io/<tu-repo>/`
...
Luego abre `http://localhost:8000/` en Chrome móvil o desktop con DevTools en modo móvil.
